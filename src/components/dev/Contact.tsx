      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="bg-accent text-white p-4 retro-border mb-1 flex justify-between items-center">
            <span className="font-black italic tracking-tighter text-xl uppercase">Contact_Terminal</span>
          ...
          <div className="p-8 md:p-16 text-center space-y-12">
            <div className="space-y-4">
              ...
              <p className="text-xl md:text-2xl font-bold opacity-70 max-w-xl mx-auto leading-tight">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {devContent.contact.socials.map((social) => (
                <a 
                  key={social.name}
                  href={social.url}
                  className="retro-border bg-background p-6 font-black text-xl hover:bg-accent hover:text-white transition-all hover:-translate-y-2 hover:retro-shadow-sm active:translate-y-0"
                >
