...
export default function Projects() {
  return (
    <section className="py-32 px-6 bg-accent/[0.03]">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-2xl">
            <h2 className="text-5xl md:text-8xl font-black tracking-tighter mb-8 leading-none">
              PROJETOS <br /> <span className="text-accent italic">SELECIONADOS</span>
            </h2>
            ...
            >
              <div className="retro-border bg-card overflow-hidden retro-shadow-sm group-hover:retro-shadow transition-all group-hover:-translate-x-1 group-hover:-translate-y-1">
                ...
                <div className="border-b-2 border-border-custom bg-background p-4 flex justify-between items-center">
                  ...
                  <span className="font-mono text-xs font-bold opacity-40">PROJECT_FILE_{i + 1}.EXE</span>
                </div>
                ...
                <div className="p-8 md:p-12 space-y-8">
                  ...
                  <div className="pt-4">
                    <a href={project.link} className="inline-block retro-border bg-foreground text-background px-6 py-3 font-black text-lg hover:bg-accent transition-colors">
                      VIEW CASE
                    </a>
                  </div>
                </div>
