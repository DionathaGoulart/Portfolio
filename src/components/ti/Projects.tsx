            ...
            <div className="retro-border bg-card overflow-hidden retro-shadow-sm group-hover:retro-shadow transition-all group-hover:-translate-x-1 group-hover:-translate-y-1 h-full">
              ...
              <div className="p-6 md:p-12 space-y-6 md:space-y-8">
                ...
                <div className="pt-2 md:pt-4">
                  <a
                    href={project.link}
                    className="inline-block w-full sm:w-auto text-center retro-border bg-foreground text-background px-6 py-3 font-black text-base md:text-lg hover:bg-accent transition-colors uppercase"
                  >
                    View Case
                  </a>
                </div>
